...
public enum ResultDict {
	...
	DEVID_TASKEVERYDAY_LIMITE("602", "同一个devId每日提交任务次数达到上限"), COINS_OR_STOCK_NOT_ENOUGH("403", "积分或库存不足"),PROVINCE_NOT_POSTAGE("123","省份没有快递"),TIME_INPUT_ERROR("124","开始时间大于结束时间"),LOGISTICS_INFO_ERROR("404", "物流信息错误");
